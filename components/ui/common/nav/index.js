...
<Flex flexDirection="row" borderRadius="md" my={2}  alignItems="center" justifyContent="space-between" p={3} height="10%" width="100%" boxShadow="dark-lg">
<Avatar size='sm' name='0X4568' src='' />
    <Flex flexDirection="column" alignItems="center">
<Text fontSize="sm" >0X4568...067f</Text>
<Text fontSize="sm" fontWeight="bold" >Ethe-Mainet</Text>
    </Flex>

</Flex>

<Flex  height="60%" width="100%" flexDirection="column" justifyContent="space-evenly" alignItems="start" >
